...
export default function NewsLetter(){
    ...
    if(showNewsLetter)
    return(
        <div className="h-screen w-full bg-black/70 fixed top-0 left-0 z-[1001] pt-10 box-border">
            <motion.div 
                className="max-w-[1000px] rounded-2xl bg-primary-black px-10 py-10 mx-auto relative"
                animate={{scale: 1, opacity: 1, top: 0, transition: { duration: 0.5 }}}
                initial={{scale: 0.9, opacity: 0.6, top: 200}}
            >
                <div className="flex justify-end w-full">
                    <div className="h-[40px] w-[40px] rounded-full bg-white/10 flex items-center justify-center cursor-pointer">
                ...
                <div className="w-full">
                    <div className="max-w-[450px] border-box bg-primary-white rounded-t-2xl p-5 mx-auto">
                        ...
                        <div className="pt-5 mt-5 border-t border-primary-black border-dashed">
                            ...
                            <div className="space-y-5 mt-3 text-[#696969] font-eculid text-sm">
                    ...
                    <div className="max-w-[650px] border-box bg-primary-white rounded-2xl p-5 mx-auto">
                        <div className="max-w-[400px] mx-auto">
                            ...
                            <div className="text-center space-y-5 mt-3 text-[#696969] max-w-[390px] mx-auto text-sm">
                            ...
                            <div className="max-w-[390px] mx-auto mt-5 space-y-2">

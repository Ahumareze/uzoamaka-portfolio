...
export default function BlogCard({image, title, details, readMinute, date}: BlogCardType){
    return(
        <div className="h-[400px] md:h-[600px] min-w-[400px] md:min-w-[600px] bg-black/20 rounded-xl bg-center bg-cover bg-no-repeat flex flex-col overflow-hidden" data-aos="fade-left" style={{backgroundImage: `url(${image.src})`}}>
